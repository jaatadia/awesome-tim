...
Linea::Linea(const char* ID,double x1,double y1,double x2, double y2,double ancho):Figura(ID,new DLinea(x1,y1,x2,y2,ancho),true)
{
	this->setCambio(true);
	puesto = false;
}
...
void Linea::setPunto1(double x1,double y1){
	...
	delete this->myVista;
	this->myVista = new VistaLinea(this,false);
}

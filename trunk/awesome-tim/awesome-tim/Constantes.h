...
#define MSG_TYPE_GREETING	MSG_VALID + 1
#define MSG_TYPE_FILES		MSG_TYPE_GREETING + 1
#define MSG_TYPE_EVENT		MSG_TYPE_FILES + 1
#define MSG_TYPE_GOODBYE	MSG_TYPE_EVENT + 1
#define SERVER_TYPE			0
#define CLIENT_TYPE			SERVER_TYPE + 1
...
//	mapa[ID_PUNTA_CINTA_DER] = new Imagen(ID_PUNTA_CINTA_DER); //punta der de cinta
	...
	mapa[ID_HUEVO_ROMPIENDO4] = new Imagen(ID_HUEVO_ROMPIENDO4);
	mapa[ID_HUEVO_ROMPIENDO5] = new Imagen(ID_HUEVO_ROMPIENDO5);
	mapa[ID_HUEVO_ROMPIENDO6] = new Imagen(ID_HUEVO_ROMPIENDO6);
	mapa[ID_DOMINO] = new Imagen(ID_DOMINO);
	mapa[ID_FICHA_DOMINO] = new Imagen(ID_FICHA_DOMINO);
	mapa[ID_BASE_CARRITO] = new Imagen(ID_BASE_CARRITO);
	mapa[ID_PUNTA_CARRITO] = new Imagen(ID_PUNTA_CARRITO);
	...
	mapa[ID_RATON_MOVIENDOSE_DERECHA0] = new Imagen(ID_RATON_MOVIENDOSE_DERECHA0);
	mapa[ID_RATON_MOVIENDOSE_DERECHA1] = new Imagen(ID_RATON_MOVIENDOSE_DERECHA1);
	mapa[ID_RATON_MOVIENDOSE_DERECHA2] = new Imagen(ID_RATON_MOVIENDOSE_DERECHA2);
	mapa[ID_RATON_MOVIENDOSE_DERECHA3] = new Imagen(ID_RATON_MOVIENDOSE_DERECHA3);
	mapa[ID_RATON_MOVIENDOSE_DERECHA4] = new Imagen(ID_RATON_MOVIENDOSE_DERECHA4);
	mapa[ID_RATON_MOVIENDOSE_DERECHA5] = new Imagen(ID_RATON_MOVIENDOSE_DERECHA5);
	mapa[ID_RATON_MOVIENDOSE_DERECHA6] = new Imagen(ID_RATON_MOVIENDOSE_DERECHA6);
	mapa[ID_RATON_MOVIENDOSE_IZQUIERDA0] = new Imagen(ID_RATON_MOVIENDOSE_IZQUIERDA0);
	mapa[ID_RATON_MOVIENDOSE_IZQUIERDA1] = new Imagen(ID_RATON_MOVIENDOSE_IZQUIERDA1);
	mapa[ID_RATON_MOVIENDOSE_IZQUIERDA2] = new Imagen(ID_RATON_MOVIENDOSE_IZQUIERDA2);
	mapa[ID_RATON_MOVIENDOSE_IZQUIERDA3] = new Imagen(ID_RATON_MOVIENDOSE_IZQUIERDA3);
	mapa[ID_RATON_MOVIENDOSE_IZQUIERDA4] = new Imagen(ID_RATON_MOVIENDOSE_IZQUIERDA4);
	mapa[ID_RATON_MOVIENDOSE_IZQUIERDA5] = new Imagen(ID_RATON_MOVIENDOSE_IZQUIERDA5);
	mapa[ID_RATON_MOVIENDOSE_IZQUIERDA6] = new Imagen(ID_RATON_MOVIENDOSE_IZQUIERDA6);

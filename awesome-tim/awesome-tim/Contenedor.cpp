...
//	mapa[ID_PUNTA_CINTA_DER] = new Imagen(ID_PUNTA_CINTA_DER); //punta der de cinta
	...
	mapa[ID_HUEVO_ROMPIENDO4] = new Imagen(ID_HUEVO_ROMPIENDO3);
	mapa[ID_HUEVO_ROMPIENDO5] = new Imagen(ID_HUEVO_ROMPIENDO3);
	mapa[ID_HUEVO_ROMPIENDO6] = new Imagen(ID_HUEVO_ROMPIENDO3);

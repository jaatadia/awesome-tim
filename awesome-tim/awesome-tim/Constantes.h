...
#define PALETA_RESTITUTION 0.06
...
#define MSG_TYPE_ACTUALIZE				MSG_TYPE_UNION2 +1 
#define MSG_TYPE_REMOVE					MSG_TYPE_ACTUALIZE +1 
#define MSG_TYPE_CLOSE_SCISSOR			MSG_TYPE_REMOVE	+1
#define MSG_TYPE_POP_BALLOON			MSG_TYPE_CLOSE_SCISSOR	+1
#define MSG_TYPE_FIRE_BOW				MSG_TYPE_POP_BALLOON +1
#define MSG_TYPE_FIRE_SHOTGUN			MSG_TYPE_FIRE_BOW+1
#define MSG_TYPE_VICTORY				MSG_TYPE_FIRE_SHOTGUN+1
#define MSG_TYPE_ROTATE					MSG_TYPE_VICTORY+1
#define MSG_TYPE_BREAK_EGG				MSG_TYPE_ROTATE+1
#define MSG_TYPE_INTERACT				MSG_TYPE_BREAK_EGG+1
#define MSG_TYPE_COUNTER				MSG_TYPE_INTERACT +1
#define MSG_TYPE_STRING					MSG_TYPE_COUNTER+1
#define MSG_TYPE_DROP					MSG_TYPE_STRING+1
#define MSG_TYPE_DELETE					MSG_TYPE_DROP+1
#define MSG_TYPE_NONE					MSG_TYPE_DELETE+1
#define SERVER_MODE